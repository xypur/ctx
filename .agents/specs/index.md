...
| bilingual-gate.8.1 | [x] | bilingual-gate | 语言契约文档冻结 | - |
| bilingual-gate.8.2 | [x] | bilingual-gate | lib.mjs 语言与结构助手 | - |
...
bilingual-gate (语言门禁：8.1 契约冻结 → 8.2/8.4 并行 → 8.3 → 8.5 对齐与注入 → 8.6)
```
